...
/**
 * IfPu002DbpDataResVO (IfPu002DbpDataResVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfPu002DbpDataResVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfPu002DbpDataResVO extends BaseVO {
	private IfHeaderDbpResVO header;
	private IfPu002ComBodyResVO body;

	public IfPu002DbpDataResVO() {
		super();
	}
