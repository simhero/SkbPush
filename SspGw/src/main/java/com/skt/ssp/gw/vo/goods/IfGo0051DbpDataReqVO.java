...
/**
 * IfGo0051DbpDataReqVO (IfGo0051DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfGo0051DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfGo0051DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfGo0051ComBodyReqVO body;

	public IfGo0051DbpDataReqVO() {
		super();
	}
