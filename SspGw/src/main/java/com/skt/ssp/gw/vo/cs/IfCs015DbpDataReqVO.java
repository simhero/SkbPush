...
/**
 * IfCs015DbpDataReqVO (IfCs015DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfCs015DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfCs015DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfCs015ComBodyReqVO body;

	public IfCs015DbpDataReqVO() {
		super();
	}
