...
/**
 * IfSe002DbpDataReqVO (IfSe002DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfSe002DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfSe002DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfSe002ComBodyReqVO body;

	public IfSe002DbpDataReqVO() {
		super();
	}
