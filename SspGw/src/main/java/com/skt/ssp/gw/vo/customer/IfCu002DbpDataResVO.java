 ...
 */
public class IfCu002DbpDataResVO extends BaseVO {
	private IfHeaderDbpResVO header;
	private IfCu002ComBodyResVO body;

	public IfCu002DbpDataResVO() {
		super();
	}
	...
	public IfCu002ComBodyResVO getBody() {
		return body;
	}

	public void setBody(IfCu002ComBodyResVO body) {
		this.body = body;
	}
