...
/**
 * IfCf004DbpDataReqVO (IfCf004DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfCf004DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfCf004DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfCf004ComBodyReqVO body;

	public IfCf004DbpDataReqVO() {
		super();
	}
