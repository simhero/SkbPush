...
/**
 * IfCs002DbpDataResVO (IfCs002DbpDataResVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfCs002DbpDataResVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfCs002DbpDataResVO extends BaseVO {
	private IfHeaderDbpResVO header;
	private IfCs002ComBodyResVO body;

	public IfCs002DbpDataResVO() {
		super();
	}
