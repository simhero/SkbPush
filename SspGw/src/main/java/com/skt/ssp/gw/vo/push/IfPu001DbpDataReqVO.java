...
/**
 * IfPu001DbpDataReqVO (IfPu001DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfPu001DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfPu001DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfPu001ComBodyReqVO body;

	public IfPu001DbpDataReqVO() {
		super();
	}
