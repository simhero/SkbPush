...
import com.skt.ssp.gw.util.StringUtil;

/**
 * Exception MailSender (ExceptionMailSender)
 *
 * @author <a href="mailto:simhero@in-sprit.com">SimByungChul</a>
 * @version $Id: ExceptionMailSender.java,v 1.0 2011/04/15 00:00:00 SimByungChul Express $
 */
public class ExceptionMailSender extends AbstractMessageSender {
	...
	public void sendMessage(Throwable e) {
		try {
			...
			helper.setTo(to);
			helper.setFrom(from);
			helper.setSubject("SSP GW Error Message");
