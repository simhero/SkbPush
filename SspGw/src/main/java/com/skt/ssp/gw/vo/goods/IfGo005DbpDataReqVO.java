...
/**
 * IfGo005DbpDataReqVO (IfGo005DbpDataReqVO)
 *
 * @author <a href="mailto:jetwo@in-sprit.com">ChoKyuJin</a>
 * @version $Id: IfGo005DbpDataReqVO.java,v 1.0 2011/09/03 00:00:00 ChoKyuJin Express $
 */
public class IfGo005DbpDataReqVO extends BaseVO {
	private IfHeaderDbpReqVO header;
	private IfGo005ComBodyReqVO body;

	public IfGo005DbpDataReqVO() {
		super();
	}
