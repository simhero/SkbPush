package com.skt.ssp.gw.aspect;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.springframework.dao.DataAccessException;

import com.skt.ssp.gw.common.ExceptionMailSender;

/**
 * ExceptionNotification Aspect  (ExceptionNotificationAspect)
 *
 * @author <a href="mailto:simhero@in-sprit.com">SimByungChul</a>
 * @version $Id: ExceptionNotificationAspect.java,v 1.0 2011/08/10 00:00:00 SimByungChul Express $
 */
public class ExceptionNotificationAspect {
	...
	public void exceptionNotiAdvice(DataAccessException Ex) {
		if (logger.isDebugEnabled()) {
			logger.info("com.skt.ssp.gw.aspect.ExceptionNotificationAspect.DataAccessException() ");
